...
func (round *round2) Start() *tss.Error {
	...
	round.started = true
	round.resetOK()
	round.temp.outMessages = make([]tss.ParsedMessage, round.PartyCount()*2)
	...
	for j, Pj := range round.Parties().IDs() {
		...
		round.temp.outMessages[j] = r2msg1
		if j == i {
	...
	round.temp.outMessages[round.PartyCount()] = r2msg2
