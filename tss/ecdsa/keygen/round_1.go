...
import (
	...
	"hwallet/tss/common"
	"hwallet/tss/crypto"
	cmts "hwallet/tss/crypto/commitments"
...
func newRound1(params *tss.Parameters, save *LocalPartySaveData, temp *localTempData) tss.Round {
	return &round1{
		&base{params, save, temp, make([]bool, len(params.Parties().IDs())), false, 1}}
}
...
func (round *round1) Start() *tss.Error {
	...
	round.started = true
	round.resetOK()
	round.temp.outMessages = make([]tss.ParsedMessage, 1)
	...
	if !ok || flatPolyGs == nil {
		panic(errors.New("---round 1. de-commitment verify failed"))
	}
